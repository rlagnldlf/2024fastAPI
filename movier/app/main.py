...
from resolver import random_items, classic_items, random_genres_items
...
@app.get("/")
async def root():
    return {"message": "Hello 김휘일의 영화추천 서비스"}
...
# 사용예:http://localhost:8000/user-based/?params=1:5&params=100:1&params=50:3
@app.get("/user-based/")
